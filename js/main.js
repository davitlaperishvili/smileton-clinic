...
$(function ($) {
    $(".js-form-step-next").on("click", function (e) {
        e.preventDefault();
        const thisForm = $(this).parents(".form-steps");
...
$(function ($) {
    ...
    whySlider.on("select.flickity", function () {
        ...
        whySlider.find(".why-slider__slide.is-selected").eq(0).prevAll(".why-slider__slide").addClass("past");
        whySlider.find(".why-slider__slide.is-selected").nextAll(".why-slider__slide").removeClass("past");
    });
});
/* Why slider END */
...
$(function ($) {
    $(".reviews-more").on("click", function () {
        ...
        $(".reviews-more span").text(text === "Скрыть отзывы" ? "Смотреть еще отзывы" : "Скрыть отзывы");
